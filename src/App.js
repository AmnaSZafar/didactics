  ...
  return (
    ...
    <Router>
        <Switch>
          ...
          <MainLayout exact path="/main/reset-password-confirmation" component={ResettPasswordRequestAuth} />
          <MainLayout exact path="/main/reset-password/:id" component={ResetPasswordAuth} />
      ...
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-digitalUrdu/:id" component={CourseContentAdultDigitalUrdu} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-video/:id" component={CourseContentVideoForTeachers} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-audio/:id" component={CourseContentAudioForTeachers} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-drawing/:id" component={CourseContentDrawingEditorComponent} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-handwriting/:id" component={CourseContentAdultHandwritingForTeacher} />
      ...
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-digitalUrdu-test/:id" component={CourseContentAdultDigitalUrduForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-video-test/:id" component={CourseContentVideoForTeachersForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-audio-test/:id" component={CourseContentAudioForTestForTeachers} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-handwriting-test/:id" component={CourseContentAdultHandwritingForTestForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-drawing-test/:id" component={CourseContentDrawingEditorComponentForTest} />
     
      <TeacherDashboardLayout path="/teacher/adult-course-content-file-upload/:id" component={FileUploadNewForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-blanks-edit/:id" component={EditContentBlanksForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-mcq-edit/:id" component={EditContentMCQForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-qa-edit/:id" component={EditContentQAForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-video-edit/:id" component={EditContentVideoForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-audio-edit/:id" component={EditContentAudioForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-digitalUrdu-edit/:id" component={EditContentDigitalUrduForTeacher} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-drawing-edit/:id" component={EditContentAdultDrawingEditorComponent} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-handwriting-edit/:id" component={EditContentHandwritingForTeacher} />
      
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-blanks-edit-test/:id" component={EditContentBlanksForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-mcq-edit-test/:id" component={EditContentMCQForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-qa-edit-test/:id" component={EditContentQAForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-video-edit-test/:id" component={EditContentVideoForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-audio-edit-test/:id" component={EditContentAudioForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-digitalUrdu-edit-test/:id" component={EditContentDigitalUrduForTeacherForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-drawing-edit-test/:id" component={EditContentAdultDrawingEditorComponentForTest} />
      <TeacherDashboardLayout path="/teacher/adult-course-content-text-handwriting-edit-test/:id" component={EditContentHandwritingForTeacherForTest} /> 
