  ...
  const handlingAttachments = () => {
    if(location.state.answertype == "Drawing"){
        return(
            <div className = "mt-4">
                    ...
                    <div class="p-3 mb-2 bg-light text-dark">
                        <img width="350" className = "text-dark" style={{textDecoration : "none", fontWeight: "bold",  boxShadow: "5px 5px #888888"}} src={`https://didactics.one/api/file/display/${location.state.questionReferenceName}`}>
                        </img>
                    </div>
                    <hr />
                </div>
        ...
        return(
            ...
            <div class="p-3 mb-2 bg-light text-dark">
                <audio src={`https://didactics.one/api/file/display/${location.state.questionReferenceName}`} id="player" controls="controls" className="" type="audio/mpeg"  />
            </div>
            <hr />
        </div> 
        )
        ...
        return(
            <div className = "mt-4">
                    ...
                    <div class="p-3 mb-2 bg-light text-dark">
                        <video controls width="400" src = {`https://didactics.one/api/file/display/${location.state.questionReferenceName}`}  type="video/webm" />
                    </div>
                    <hr />
                </div>
        )
...
const handlingAnswerAttachments = () => {
    if(location.state.answertype == "Drawing"){
        ...
        <div class="p-3 mb-2 bg-light text-dark">
            <img width="350" className = "text-dark" style={{textDecoration : "none", fontWeight: "bold",  boxShadow: "5px 5px #888888"}} src={`https://didactics.one/api/file/display/${location.state.referenceName}`}>
            </img>
        </div>
        <hr />
    </div>
...
<div className="containerBlackDashboard-fluid">
  ...
  <div className="card shadow mb-4">
    <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
      <h6 className="m-0 font-weight-bold text-white">{location.state.grade} {location.state.name}'s Question Content </h6>
    </div>
  ...
  <div className="card shadow mb-4">
    <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
      <h6 className="m-0 font-weight-bold text-white">{location.state.grade} {location.state.name}'s Answer</h6>
    </div>
    <div className="card-body">
    <div>
    <div className = "mt-4">
                  ...
                  <div className = "mt-4">
                      <div class="p-3 mb-2 " style = {{color : "white", backgroundColor : "#a98799"}}>
                          ...
                          <div className="containerSass mt-3 mb-3">
                                <button type = "submit" className="btnSass play-pause buttonSass" style = {{fontWeight : "bold", width: "100px", height: "100px" }}>
