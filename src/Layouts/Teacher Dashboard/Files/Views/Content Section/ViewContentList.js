...
function ViewContentListForTeacher() {
    ...
    const handleOnClickEdit = (data) => {
      if ((data.coursetype == "Adult Training") && (data.questiontype === "Text") && (data.answertype === "Text")){
        ...
        history.push({
          pathname:"/adult-course-content-file-upload",
          state: data
        })
      }
    ...
    const handleOnClickDelete = (data) => {
      axios.delete('http://localhost:3001/coursePlannings/delete/' + data._id)
            .then((res) => {
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold">List of Student Answers</h6>
      </div>
