  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      <div className="card-header py-3" style = {{color : "white", backgroundColor : "#a98799"}}>
        <h6 className="m-0 font-weight-bold text-white">{location.state.grade} Course Q/A Content Edit Panel</h6>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className = "mt-4"> 
                    ...
                    <div className="buttonNewTheme mt-3 mb-3 text-center">
                        <button type="submit" className="btnSass play-pause buttonSass" style ={{fontWeight: 'bold', height: '115px', width: '115px'}}>
                          Save Changes
                        </button>
                    </div>
                  </form>
