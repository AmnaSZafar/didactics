...
export const getTeachers = (subjectChoosenForApplication, gender) => (
	...
	axios.post(`https://didactics.one/teachers/admin/${subjectChoosenForApplication}&${gender}`)
		.then(res => res.data, )
)
...
export const updateTeacher = (todo, id) => fetch(`https://didactics.one/teachers/${id}`, {
  method: "POST",
  headers: {
    "Accept": "application/json",
    "Content-Type": "application/json"
...
export const updateCoursePlannings = (todo, id) => fetch(`https://didactics.one/teachers/${id}`, {
  method: "POST",
  headers: {
    "Accept": "application/json",
    "Content-Type": "application/json"
