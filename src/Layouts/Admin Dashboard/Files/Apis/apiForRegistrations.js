...
export const getRegistrations = (classesGrade, gender) => (
	console.log(classesGrade, gender),
	axios.post(`https://didactics.one/students/admin/${classesGrade}&${gender}`)
		.then(res => res.data, )
)
...
export const updateRegistration = (todo, id) => fetch(`https://didactics.one/students/${id}`, {
  method: "POST",
  headers: {
    "Accept": "application/json",
    "Content-Type": "application/json"
