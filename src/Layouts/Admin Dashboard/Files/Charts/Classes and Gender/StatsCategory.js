...
function StatsCategory() {
  ...
  <Row className="mt-3">
      <Col md="6">
      <div className="containerResultCategory mt-3 mb-3">
                              <button className="btnResultCategory play-pause buttonResultCategory" style = {{fontWeight : "bold", width: "100px", height:"100px"}} value = "StatsOfClassVsGender" onClick={(e) => handleOnClick(e)}>
                              Class <br /> Gender
                              </button>
                            </div>
        </Col>
        <Col md="6">
        <div className="containerResultCategory mt-3 mb-3">
                              <button className="btnResultCategory play-pause buttonResultCategory" style = {{fontWeight : "bold", width: "100px", height:"100px" }} value = "StatsOfProvincesVsGendersVsClasses" onClick={(e) => handleOnClick(e)}>
                             Class  <br/> Gender <br />  Province
                              </button>
                            </div>
        </Col>
        </Row>
