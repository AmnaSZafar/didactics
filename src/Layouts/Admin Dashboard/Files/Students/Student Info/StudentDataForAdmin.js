...
function StudentDataForAdmin() {
  ...
  useEffect(() => {
    const fetchItems = async function() {
      const teachers = await getRegistrations(location.state.classesGrade, location.state.gender)
      setItems(teachers)
    }
    fetchItems()
  }, []);
                            ...
                            items.map(students => (
                                ...
                                <td>
                                  <div className="buttonNewTheme mt-3 mb-3 text-center">
                                    <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"108px", width: "108px"}}  onClick={() => handleOnClickInfo(students)}>View Info</button>
                                  </div>
                                </td>
                                <td>
                                  <div className="buttonNewTheme mt-3 mb-3 text-center">
                                    <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"108px", width: "108px"}}  onClick={() => handleOnClickApprove(students)}>Approve</button>
                                  </div>
                                </td>
                                <td>
                                  <div className="buttonNewTheme mt-3 mb-3 text-center">
                                    <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"108px", width: "108px"}}  onClick={() => handleOnClickDisapprove(students)}>Disapprove</button>
                                  </div>
                                </td>
                                <td>
                                  <div className="buttonNewTheme mt-3 mb-3 text-center">
                                    <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"108px", width: "108px"}}  onClick={() => handleOnClickRemove(students)}>Remove</button>
                                  </div>
                                </td>
                                </tr>
                            ))
