       ...
       <HTMLFlipBook
             ...
             >
                 ...
                 </div>
                 {
                              items.map(contents => (
                                  <div className="page" key={contents._id}>
                                    ...
                                    <div className = "mt-5">
                                      <img className = "text-dark" style={{textDecoration : "none", fontWeight: "bold", height:"300px", width:"400px", boxShadow: "5px 5px #888888"}} src={`https://didactics.one/api/file/display/${contents.referenceName}`}>
                                      </img>
                                    </div>
              ...
              <div className="buttonNewTheme mt-3 mb-3 text-center">
                  <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"90px", width: "90px"}}   onClick={() => book.current.pageFlip().flipPrev()}>
                     Prev page
                  </button>
                  <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"90px", width: "90px"}}   onClick={() => book.current.pageFlip().flipNext()}>
                    Next page
                  </button>
              </div>
