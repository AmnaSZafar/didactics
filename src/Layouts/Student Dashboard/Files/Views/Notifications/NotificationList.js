      ...
      <div className="table-responsive">
                        ...
                        <tbody>
                            ...
                            items.map(contents => (
                                ...
                                <div className="buttonNewTheme mt-3 mb-3 text-center">
                                  <button className="btnSass play-pause buttonSass" onClick={() => handleOnClickCheckResponse(contents)} style = {{fontWeight : "bold", height : "114px", width: "114px"}}>
                                    Teacher's Response
                                  </button>
                                </div>
                                </td>
                                ...
                                <td>
                                <div className="buttonNewTheme mt-3 mb-3 text-center">
                                  <button className="btnSass play-pause buttonSass"  onClick={() => handleOnClickEdit(contents)} style = {{fontWeight : "bold", height : "115px", width: "115px",}}>
                                    Edit Query
                                  </button>
                                </div>
                                </td>
        ...
        <center>
                    ...
                    <div className="buttonNewTheme mt-3 mb-3">
                      <button className="btnSass play-pause buttonSass" style = {{fontWeight : "bold", height : "95px", width: "95px"}} onClick = {(e) => onCreateBlog(e)}>
                        Create Query
                      </button>
                    </div>
                  </div>
