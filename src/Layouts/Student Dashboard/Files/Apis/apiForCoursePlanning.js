...
export const getCoursePlanningsForGrade1 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-1/${id}`)
		.then(res => res.data, )
)
...
export const getCoursePlanningsForGrade2 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-2/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade3 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-3/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade4 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-4/${id}`)
		.then(res => res.data, )
)
...
export const getCoursePlanningsForGrade5 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-5/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade6 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-6/${id}`)
		.then(res => res.data, )
)
...
export const getCoursePlanningsForGrade7 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-7/${id}`)
		.then(res => res.data, )
)
...
export const getCoursePlanningsForGrade8 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-8/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade9 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-9/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade10 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-10/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade11 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-11/${id}`)
		.then(res => res.data, )
)

export const getCoursePlanningsForGrade12 = id => (
	console.log(id),
	axios.post(`https://didactics.one/coursePlannings/Students-Grade-12/${id}`)
		.then(res => res.data, )
)
