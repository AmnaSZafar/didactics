...
<div id="content">
  ...
  <div className="containerBlackDashboard-fluid">
    ...
    <div className="card shadow mb-4 text-center">
      ...
      <div className = "mt-4">
      <img className = "text-dark" style={{textDecoration : "none", fontWeight: "bold", height:"300px", width:"400px", boxShadow: "5px 5px #888888"}} src={`https://didactics.one/api/file/display/${file}`}>
      </img>
      </div>
      </div>
      </div>
