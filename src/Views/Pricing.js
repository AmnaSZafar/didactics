      ...
      <section id="pricing" className="pricing mt-5">
        <div className="container">
          ...
          <div className="row no-gutters">
            <div className="col-lg-4 box p-4" data-aos="fade-right">
              <h3>Free</h3>
            ...
            <div className="col-lg-4 p-4 box featured" data-aos="fade-up">
              <h3>Business</h3>
            ...
            <div className="col-lg-4 p-4 box" data-aos="fade-left">
              <h3>Developer</h3>
