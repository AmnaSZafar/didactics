...
import ModalTest from './Plugins/Web Cam Capture/For Teachers/ModalTest';
...
function TeachersRegistration() {
  ...
  const onSubmit = async (data) => {
    ...
    await createTodoForTeachers(data)
    //redirecting 
    //history.push("/")
  };
      ...
      <div>
          ...
          <section id="hero" className="contact">
            <div className="container" data-aos="fade-up">
              ...
              <h1><span><i className="fas fa-chalkboard-teacher fa-lg"></i></span><span style = {{paddingLeft : "15px", fontWeight : "bold"}}>Teacher's Registration Form</span></h1>
                {/*}
                ...
                <div className="row">
                      <div className="col-md-6 mt-3">
                        ...
                        <label htmlFor>Full Name</label>
                            <input type="text" name="name" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.name} className="form-control form-control-lg"  />
                        ...
                        <div className="form-group">
                          ...
                          <select name="gender" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.gender} id className="form-control rounded-0" >
                            <option value="chooseGender">Choose Gender</option>
                            <option value="male">Male</option>
                            <option value="female ">Female </option>
                            <option value="unspecify">Unspecify</option>
                          </select>
                          {formik.touched.gender ? (<div className='error'>{formik.errors.gender}</div>) : null}
                        </div>
                        </div>
                      <div className="col-md-6 mt-3">
                          ...
                          {formik.touched.dob ? (<div className='error'>{formik.errors.dob}</div>) : null}
                    </div>
                      ...
                      <div className="col-md-6 mt-3">
                        ...
                        {formik.errors.conf_pass && formik.touched.conf_pass ? (<div className='error'>{formik.errors.conf_pass}</div>) : null}
                      </div>
                      <div className="row mt-4">
                        {/* <div className="col-md-6 col-lg-6">
                          <div className="form-group">
                            <label htmlFor="rating_from">Course:</label>
                            <select name="subjects" onChange={formik.handleChange}  onBlur={formik.handleBlur} value={formik.values.subjects} className="form-control rounded-0" required>
                              <option value="selectCourse">Select Course</option>
                              <option value="English">English</option>
                            
                            </select>
                            {formik.touched.subjects ? (<div className='error'>{formik.errors.subjects}</div>) : null}
                          </div>
                        </div> */}
                        ...
                        {/* <div className="col-md-3 col-lg-3">
                          <div className="form-group">
                            ...
                            <select name="country_code" onChange={formik.handleChange} value={formik.values.country_code} className="form-control rounded-0" required>
                                ...
                                <div class="col-sm-6 mt-3">
                                    <div className="form-group">
                                        <label htmlFor>Country Code</label>
                                            ...
                                            {/*{formik.touched.country_code ? (<div className='error'>{formik.errors.country_code}</div>) : null} */}
                                    </div></div>
                            <div className="col-sm-6 mt-3"><div className="form-group">
                            <label htmlFor>Phone</label>
                                <input type="text" name="phone" placeholder="Enter your Contact" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.contact} className="form-control form-control-lg" maxLength={11} required />
                                {formik.errors.phone && formik.touched.phone ? (<div className='error'>{formik.errors.phone}</div>) : null}
                              </div></div>
                            </div>
                            </div>
                      <div className="col-md-6 mt-3 country_div">
                        <div className="form-group">
                          ...
                          <select name="nationality" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.nationality} className="form-control rounded-0" >
                          ...
                          {formik.touched.nationality ? (<div className='error'>{formik.errors.nationality}</div>) : null}
                        </div>
                      </div>
                      <div className="col-md-6 mt-3 country_div">
                        <div className="form-group">
                          <label htmlFor="sel1">Current Location</label>
                          <select name="country" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.country} className="form-control rounded-0" >
                      ...
                      <div className="col-md-6 mt-3">
                      <div className="form-group">
                        <label htmlFor>Please give a short description of yourself</label>
                        <textarea type="text" name="description"  className="form-control" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.description} required />
                      </div>
                    </div>
                    <div className="col-md-6 mt-3">
                      <div className="form-group">
                        ...
                        <div>
                        <input type="file" name="cv" className="form-control h-25 mt-3" required  onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.cv} />
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 mt-3">
                      <div className="form-group">
                        <label htmlFor>Please upload a recent image of yourself. Please note that if your application is successful, this photo will be used as your profile picture.</label>
                        <input type="file" name="image" className=" h-25 form-control" required  onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.image} />
                      </div>
                    </div>
                    <div className="col-md-6 mt-3">
                    <div className="form-group">
                   
                        <label htmlFor>Please give a short video description of why you would like to become a teacher with Linguistics</label>
                        <div className = "mt-3">
                        <ModalTest  />
                        </div>
                    </div>
                    ...
                    <center>
                          <button type="submit" className = "w-10 mt-5">
                            <span><i className="fa fa-file fa-lg"></i></span><span style = {{paddingLeft : "15px", fontWeight : "bold"}}>Register</span>
                          </button>
                      </center>
                    </div>
                </form>
