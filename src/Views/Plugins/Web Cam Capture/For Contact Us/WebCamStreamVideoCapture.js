...
function WebCamStreamVideoCapture() {
    ...
    return (
      ...
      <div style = {{height : "250px"}}> 
        ...
        {capturing ? (
          <div>
          <button className="btn rounded-circle p-3 shadow-sm" onClick={handleStopCaptureClick}>  <i className="fa fa-pause-circle-o"></i>  </button>
          </div>
        ) : (
          <div>
          <button className="btn rounded-circle p-3 shadow-sm" onClick={handleStartCaptureClick}>  <i className="fa fa-play-circle-o text-secondary"></i>  </button>
          </div>
         
        )}
        {recordedChunks.length > 0 && (
          // <div className = "buttonNewTheme">
          <button className="btn rounded-circle p-3 shadow-sm" onClick={handleDownload}>  <i className="fa fa-arrow-circle-o-down"></i>  </button>
          // </div>
        )}
        </div>
      </>
