...
var { AnswersTest } = require('../../models/Student Section/AnswerTestSchema')
 ...
 //To use this post requeest we need to type https://didactics.one/employees/, this is coming from index.js 
...
router.post('/specific/subject/:id&:coursetype', (req, res) => {
  ...
  AnswersTest.find({ "studentId" : id, "coursetype" : coursetype} , (err, student) => {
    res.json(student);
  });
}); 
