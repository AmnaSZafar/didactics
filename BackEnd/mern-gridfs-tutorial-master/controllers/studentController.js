...
router.post('/admin/:classesGrade&:gender', (req, res) => {
    console.log("test")
    const classesGrade = req.params.classesGrade;
    const gender = req.params.gender;
    Student.find({ "classesGrade" : classesGrade, "gender" : gender} , (err, student) => {
      res.json(student);
    });
  }); 
